 ...
 */
public abstract class TFIDFWithoutQueryNormSimilarity extends Similarity {

    /**
     * Sole constructor. (For invocation by subclass
     * constructors, typically implicit.)
     */
    public TFIDFWithoutQueryNormSimilarity() {}
    ...
    public final SimWeight computeWeight(CollectionStatistics collectionStats, TermStatistics... termStats) {
        ...
        return new IDFWithoutQueryNormStats(collectionStats.field(), idf);
    }

    @Override
    public final SimScorer simScorer(SimWeight stats, LeafReaderContext context) throws IOException {
        IDFWithoutQueryNormStats idfstats = (IDFWithoutQueryNormStats) stats;
        return new TFIDFWithoutQueryNormSimScorer(idfstats, context.reader().getNormValues(idfstats.field));
    }

    private final class TFIDFWithoutQueryNormSimScorer extends SimScorer {
        private final IDFWithoutQueryNormStats stats;
        private final float weightValue;
        private final NumericDocValues norms;

        TFIDFWithoutQueryNormSimScorer(IDFWithoutQueryNormStats stats, NumericDocValues norms) throws IOException {
            this.stats = stats;
    ...
    private static class IDFWithoutQueryNormStats extends SimWeight {
        ...
        public IDFWithoutQueryNormStats(String field, Explanation idf) {
            // TODO: Validate?
            this.field = field;
            this.idf = idf;
            normalize(1f, 1f);
    ...
    private Explanation explainQuery(IDFWithoutQueryNormStats stats) {
        List<Explanation> subs = new ArrayList<>();
    ...
    private Explanation explainField(int doc, Explanation freq, IDFWithoutQueryNormStats stats, NumericDocValues norms) {
    ...
    private Explanation explainScore(int doc, Explanation freq, IDFWithoutQueryNormStats stats, NumericDocValues norms) {
