 ...
 */
public class DefaultWithoutQueryNormSimilarity extends TFIDFWithoutQueryNormSimilarity {
    ...
    public DefaultWithoutQueryNormSimilarity(Settings settings) {
    ...
    public String toString() {
        return "DefaultWithoutQueryNormSimilarity";
    }
}